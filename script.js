cj(function($) {
    // Declare CSS variables
        var commuter_adult_days = ".Commuter_Adult_Days-section",
            ...
            overnight_adult_daily_dorm = ".Overnight_Adult_Daily_Dorm_Qty-section",
            overnight_adult_daily_dorm_days = ".Overnight_Adult_Daily_Dorm_Days-section",
            overnight_adult_daily_semi_private = ".Overnight_Adult_Daily_Semi_priv-section",
            overnight_adult_daily_camping_qty = ".Overnight_Adult_Daily_Camping_Q-section",
            overnight_adult_daily_camping_days = ".Overnight_Adult_Daily_Camping_D-section",
            overnight_young_friend_full_week = ".vernight_Young_Friend_Full_Wee-section",
            ...
            overnight_youth_daily_camping_qty = ".rm-section Overnight_Youth_Daily_Camping_Q-section",
